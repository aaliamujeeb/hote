...
<!-- ADD FORM -->
<form method="POST" action="/admin/offers" enctype="multipart/form-data" class="mb-4">
    @csrf
    ...
    <button class="btn btn-warning">Add Offer</button>
</form>
...
<table class="table table-dark table-striped align-middle">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ Str::limit($offer->description, 40) }}</td>
